...
<div>
<span className={styles["website-name"]}>BrainStorm</span><span className={styles["website-name"]}>Community</span>
</div>
    </div>
    {button}
    {userLoggedIn && 
    ...
    <Link href={'/questions/ask'}>
      <a role="link" className={styles['ask-question']}>
       ...
       <span className={styles["ask-question-text"]}>Ask a question</span> 
      </a>
    </Link>
</>}
    </div>
