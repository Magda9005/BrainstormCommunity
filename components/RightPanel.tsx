...
const RightPanel:React.FC <RightPanelProps>=({questionsList,openQuestion,avatarUrl,author,posts})=>
    (
   ...
   <div className={styles.hash}>•</div> <a className={styles['link']}> Please read rules before you start working on a platform</a>
    </div>
    </Link>
    <Link href={'/vision'}>
      <a role="link">
    ...
    <div className={styles.hash}> •
        </div><a className={styles['link']}> Vision & strategy of BrainstormCommunity</a>
          </div>
          </a>
          </Link>
          </div>
        ...
        />
            ...
            <span className={styles['featured-links-title']}>Featured Links </span>
        </div>
        <div className={styles['links-container']}>
      <div className={styles['link-wrapper']}>  
   <div className={styles.hash}>•</div> <a className={styles['link']}> BrainstormCommunity source-code on GitHub</a>
    </div>
          </div>
            </div>
