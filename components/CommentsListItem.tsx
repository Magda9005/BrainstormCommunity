...
export const CommentListItem:React.FC<CommentListItemProps>= ({avatarUrl,authorName,date,commentContent,thumbsUp,thumbsDown,commentAlreadyVotedByUser,addThumbUp,checkIfAlreadyLiked,removeThumbUp,checkIfAlreadyUnliked,addThumbDown,removeThumbDown})=>{
...
return(
    ...
    <div className={styles['votes-container']}>
        <div className={styles['thumbup-icon-wrapper']} onClick={()=>{
            if(
           ...
           setUnlikesCount(unlikesCount=>unlikesCount-1);
            ...
            else if(!isLiked && !commentAlreadyVotedByUser() && !isUnliked ){
                setLikesCount(likesCount=>likesCount+1) ;
                setIsLiked(true) ;
                addThumbUp();
            }
        ...
        <div className={styles['thumbdown-icon-wrapper']} onClick={()=>{
