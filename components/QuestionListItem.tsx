...
const QuestionListItem:React.FC<QuestionListItemProps>=({nickname,date,title,text,imageUrl,tags,viewsAmount,commentsAmount,upvotesAmount,
    postId,handleIncreaseViews,userLoggedIn})=>
    (
...
<div className={styles["dots-vertical-wrapper"]} onClick={handleIncreaseViews}>
<Image
